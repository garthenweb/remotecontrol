...
export default applyMiddleware(
  ...
  powerSchedule.activatePlantLightOnLeave,
  powerSchedule.deactiavtePlantLightOnEnter,
  powerSchedule.actiavtePlantLightAtDay,
  powerSchedule.deactiavtePlantLightAtNight,
  ...locationLookup,
  sunStateImport,
);
